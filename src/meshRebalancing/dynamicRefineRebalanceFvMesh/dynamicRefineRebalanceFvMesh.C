...
)
{
    ...
    #if OPENFOAM >= 2506
    volScalarField::Internal* V0Ptr(this->V0Ptr_.release());
    volScalarField::Internal* V00Ptr(this->V00Ptr_.release());
    #else
    volScalarField::Internal* V0Ptr(this->V0Ptr_);
    volScalarField::Internal* V00Ptr(this->V00Ptr_);
    #endif
    #if OPENFOAM >= 2406
    surfaceScalarField* phiPtr(this->phiPtr_.release());
    #else
